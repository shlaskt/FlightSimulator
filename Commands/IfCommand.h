...
public:
    IfCommand(DataReaderServer* data_server,Client* client_data,Interpreter* interpreter1,
    ...
    bool checkCondition(string expression_1, string expression_2, string condition,
